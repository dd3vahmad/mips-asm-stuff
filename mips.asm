...
main:
    ...
    jal fib
    move $t5, $v0 # save result of fib(n1) in temporary register ($t5)
    ...
    move $v0, $t5 # put fib(n1) back into $v0 (so move $s0,$v0 in the block matches)
...
fib:
    ...
    li $t9, 12
    sub $sp, $sp, $t9 # allocate 12 bytes
    sw $ra, 8($sp) # save ra
